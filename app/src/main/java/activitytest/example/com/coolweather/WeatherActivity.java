...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_wrather );
    ...
    private void initView(){
        weatherLayout=(ScrollView)findViewById ( R.id.weather_layou );
        ...
        swipeRefresh=(SwipeRefreshLayout)findViewById ( R.id.swpie_refresh );
